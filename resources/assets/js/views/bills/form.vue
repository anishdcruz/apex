                ...
                <div class="row form">
                    <div class="col-sm-5">
                        <div class="form-group">
                            <label>Vendor</label>
                            <typeahead @changed="changeCurrency" :items="option.vendors"
                                v-model="form.vendor_id"></typeahead>
                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.vendor_invoice_no">
                            <small class="e-text" v-if="errors.vendor_invoice_no">{{errors.vendor_invoice_no[0]}}</small>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <label>Date</label>
...
<script type="text/javascript">
    ...
    export default {
        ...
        created() {
            if(this.$route.meta.mode === 'bill') {
                this.title = 'Convert Purchase Order to Bill'
                this.initalize = `purchase_orders/${this.$route.params.id}/edit?convert=bill`
                this.store = `bills`
                this.method = 'post'
                this.button = 'Convert to Bill'
            }
            this.fetchData()
        },
        computed: {
