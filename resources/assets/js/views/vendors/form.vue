                ...
                <div class="row form">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" v-model="form.payment_details"></textarea>
                            <small class="e-text" v-if="errors.payment_details">{{errors.payment_details[0]}}</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        created() {
            if(this.$route.meta.mode === 'edit') {
                ...
                this.initalize = `vendors/${this.$route.params.id}/edit`
                this.store = `vendors/${this.$route.params.id}`
                this.method = 'put'
                this.button = 'Save'
            }
            this.fetchData()
